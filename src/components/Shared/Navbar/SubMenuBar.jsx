...
const SubMenuBar = ({ setNavToggle, navData, isOpen }) => {
  ...
  return (
    <div
      className={`sub_nav_manu bg-secondary py-8 pb-16 z-10 shadow-lg absolute top-16 left-0 right-0 w-full h-auto p-1 text-white transition-all duration-300 ease-out ${
        isOpen
