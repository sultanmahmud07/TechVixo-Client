      ...
      <div className="main_container">
        ...
        <div className="py-5 md:py-8 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 max-w-6xl mx-auto">
          {services.map((service, i) => (
            <div key={i} className="service_card rounded-md shadow border border-[#F1F1F1] bg-white p-3 md:p-5 h-full flex flex-col justify-between">
              <div>
                <div className="service_icon w-full h-44 rounded overflow-hidden flex items-center justify-center mb-4">
                  <Image
                    src={service.icon}
                    alt={service.name}
                    width={400}
