  ...
  const facilities = [
    {
      ...
      description: "Optimized server responses and lightweight frontend modules ensure near-instantaneous page loads.",
      icon: "/assets/images/services/category/design/service-icon/1.png"
    },
    {
      id: 2,
      title: "Ironclad Security Standards",
      description: "Robust database encryption, OAuth validation, and regular code audits protect your users and data.",
      icon: "/assets/images/services/category/design/service-icon/2.png"
    },
    {
      id: 3,
      title: "Scalable Cloud Integration",
      description: "Docker-ready codebases and modular microservices ready to scale up and handle massive user traffic.",
      icon: "/assets/images/services/category/design/service-icon/3.png"
    },
    {
      id: 4,
      title: "Maintainable Codebase Structure",
      description: "Well-documented classes, clean MVC/modular separation, and clean Git commits ensure easy future updates.",
      icon: "/assets/images/services/category/design/service-icon/1.png"
    }
  ];
  ...
  return (
    <div className="my-5 md:my-14">
      <div className="main_container">
        <h3 className="sut_title text-center uppercase">DEVELOPMENT HELPS</h3>
        <div className="top_title_design flex flex-col items-center">
          <h2 className="text-center text-2xl md:text-4xl font-bold text-[#111204] my-3 md:my-5">
            How Custom Engineering Propels Your Digital Success
          </h2>
        </div>
