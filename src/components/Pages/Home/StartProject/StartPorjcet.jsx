...
const StartProject = () => {
  ...
  return (
    <div className="start_project_design py-7 md:py-14 bg-secondary">
      <div className="main_container">
        ...
        <Image
          ...
          <p className='text-[#FFFFFFCC] text-center text-sm md:text-base w-full md:w-3/4'>Senior experts. On-demand requests. Fast
